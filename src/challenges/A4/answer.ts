...
//         const thisDay = new Date(message.sentAt)
        
//         if(!days.includes(thisDay.toISOString())){
//             days.push(new Date(thisDay).toISOString())
//         }
//     })

//     const result = days.map((day) => {
//         messages.forEach((message) => {
//             if(message.sentAt === day.toISOString()){
//                 return {day: day.toISOString(), messages: [message]}
//             }
//         })
//         return {day: day.toISOString(), messages: []}
//     })
